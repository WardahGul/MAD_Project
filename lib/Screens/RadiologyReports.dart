...
class RadiologyReport extends StatefulWidget {
  ...
  RadiologyReport({required this.doctorId, required this.patientId});
  @override
  State<RadiologyReport> createState() => RadiologyReportState();
}

class RadiologyReportState extends State<RadiologyReport> {
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              savePatientHistory('radio-reports', data);
