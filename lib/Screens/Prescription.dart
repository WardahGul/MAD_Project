...
class Prescription extends StatefulWidget {
  ...
  Prescription({required this.doctorId, required this.patientId});
  @override
  State<Prescription> createState() => Prescrip_State();
}

class Prescrip_State extends State<Prescription> {
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              final data = {
                'prescription': t2.text,
              };
              savePatientHistory('Prescriptions', data);
