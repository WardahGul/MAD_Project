...
class Surgery_temp extends StatefulWidget {
  final String doctorId;
  final String patientId;

  Surgery_temp({required this.doctorId, required this.patientId});
  @override
  State<Surgery_temp> createState() => Surgery_tempState();
}

class Surgery_tempState extends State<Surgery_temp> {
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              savePatientHistory('Surgery', data);
