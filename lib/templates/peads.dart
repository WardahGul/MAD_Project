...
class peads_temp extends StatefulWidget {
  final String doctorId;
  final String patientId;

  peads_temp({required this.doctorId, required this.patientId});
  @override
  State<peads_temp> createState() => peads_tempState();
}

class peads_tempState extends State<peads_temp> {
