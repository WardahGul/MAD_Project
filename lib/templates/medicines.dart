...
class medicine_temp extends StatefulWidget {
  final String doctorId;
  final String patientId;

  medicine_temp({required this.doctorId, required this.patientId});
  @override
  State<medicine_temp> createState() => medicine_tempState();
}

class medicine_tempState extends State<medicine_temp> {
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              savePatientHistory('medicines', data);
